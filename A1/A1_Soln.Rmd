...
<!-- TODO: what's N_i in this case?? -->
- $h(\mu_{i})$ is the logit link function

Within $X_{i}$, the variables are composed of age centered around 16 and indicator variables for Region (Rural / Urban), Race (Black, Hispanic, Asian, Native, Pacific), and Sex (Male, Female).
