...
Another imporvement could be adding a geom dot of the mean for each decade to the box plot as in week4's lab. This is because boxplot only shows quartiles instead of means. Adding the mean to the plot gives a more precise observation.
...
The constraint fot the restricted model is that the ages greater than 15 are combined together. All ages above 15 are considered as 1 for the dummy variable.
